...
CREATE TABLE actor (
    actor_id uuid DEFAULT nextval('actor_actor_id_seq'::regclass) NOT NULL,
...
CREATE TABLE category (
    category_id uuid DEFAULT nextval('category_category_id_seq'::regclass) NOT NULL,
...
CREATE TABLE film (
    film_id uuid DEFAULT nextval('film_film_id_seq'::regclass) NOT NULL,
...
CREATE TABLE address (
    address_id uuid DEFAULT nextval('address_address_id_seq'::regclass) NOT NULL,
...
CREATE TABLE city (
    city_id uuid DEFAULT nextval('city_city_id_seq'::regclass) NOT NULL,
...
CREATE TABLE country (
    country_id uuid DEFAULT nextval('country_country_id_seq'::regclass) NOT NULL,
...
CREATE TABLE customer (
    customer_id uuid DEFAULT nextval('customer_customer_id_seq'::regclass) NOT NULL,
...
CREATE TABLE inventory (
    inventory_id uuid DEFAULT nextval('inventory_inventory_id_seq'::regclass) NOT NULL,
    film_id uuid NOT NULL,
    store_id uuid NOT NULL,
    last_update timestamp without time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE language (
    language_id uuid DEFAULT nextval('language_language_id_seq'::regclass) NOT NULL,
...
CREATE TABLE payment (
    payment_id uuid DEFAULT nextval('payment_payment_id_seq'::regclass) NOT NULL,
...
CREATE TABLE rental (
    rental_id uuid DEFAULT nextval('rental_rental_id_seq'::regclass) NOT NULL,
...
CREATE TABLE staff (
    staff_id uuid DEFAULT nextval('staff_staff_id_seq'::regclass) NOT NULL,
    first_name character varying(45) NOT NULL,
    last_name character varying(45) NOT NULL,
    address_id uuid NOT NULL,
    email character varying(50),
...
CREATE TABLE store (
    store_id uuid DEFAULT nextval('store_store_id_seq'::regclass) NOT NULL,
...
--
-- Name: film_in_stock(uuid, uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION film_in_stock(p_film_id uuid, p_store_id uuid, OUT p_film_count uuid) RETURNS SETOF uuid
    AS $_$
     SELECT inventory_id
     FROM inventory
     WHERE film_id = $1
...
ALTER FUNCTION public.film_in_stock(p_film_id uuid, p_store_id uuid, OUT p_film_count uuid) OWNER TO postgres;

--
-- Name: film_not_in_stock(uuid, uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION film_not_in_stock(p_film_id uuid, p_store_id uuid, OUT p_film_count uuid) RETURNS SETOF uuid
    AS $_$
    SELECT inventory_id
    FROM inventory
    WHERE film_id = $1
...
ALTER FUNCTION public.film_not_in_stock(p_film_id uuid, p_store_id uuid, OUT p_film_count uuid) OWNER TO postgres;

--
-- Name: get_customer_balance(uuid, timestamp without time zone); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION get_customer_balance(p_customer_id uuid, p_effective_date timestamp without time zone) RETURNS numeric
    AS $$
...
DECLARE
    ...
    v_overfees uuid;      --#LATE FEES FOR PRIOR RENTALS
...
ALTER FUNCTION public.get_customer_balance(p_customer_id uuid, p_effective_date timestamp without time zone) OWNER TO postgres;

--
-- Name: inventory_held_by_customer(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION inventory_held_by_customer(p_inventory_id uuid) RETURNS uuid
    AS $$
DECLARE
    v_customer_id uuid;
BEGIN
...
ALTER FUNCTION public.inventory_held_by_customer(p_inventory_id uuid) OWNER TO postgres;

--
-- Name: inventory_in_stock(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION inventory_in_stock(p_inventory_id uuid) RETURNS boolean
    AS $$
DECLARE
    v_rentals uuid;
    v_out     uuid;
...
ALTER FUNCTION public.inventory_in_stock(p_inventory_id uuid) OWNER TO postgres;
...
--
-- Name: rewards_report(uuid, numeric); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION rewards_report(min_monthly_purchases uuid, min_dollar_amount_purchased numeric) RETURNS SETOF customer
    AS $_$
DECLARE
...
BEGIN
    ...
    */
    CREATE TEMPORARY TABLE tmpCustomer (customer_id uuid NOT NULL PRIMARY KEY);
...
ALTER FUNCTION public.rewards_report(min_monthly_purchases uuid, min_dollar_amount_purchased numeric) OWNER TO postgres;
